...
Route::middleware(['admin'])->prefix('sd_admin')->group(function () {
    ...
    Route::get('/product-images',[App\Http\Controllers\Admin\ProductController::class, 'image'])->name('product.image');
    Route::post('/product/image/upload',[App\Http\Controllers\Admin\ProductController::class, 'image_upload'])->name('product_image_upload');
    Route::get('/product/image/delete{id}',[App\Http\Controllers\Admin\ProductController::class, 'image_delete'])->name('product_image_delete');
    Route::post('/product/review/image/upload',[App\Http\Controllers\Admin\ProductController::class, 'review_image_upload'])->name('product_review_image_upload');
...
//admin login
Route::prefix('sd_admin')->group(function () {
